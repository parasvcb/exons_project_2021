...
export class RenderExonsFull extends Component {
  ...
  render() {
    ...
    //console.log("inside render--->ss,aa,dom",this.state.showSs,this.state.showAaseq,this.state.showDom,this.state.showFasta);
    const exonHash = this.props.exOn;
    const trans = this.props.transwhole;
    const domset = this.props.domset;
    console.log("TID",trans.tId)
    //console.log("this.showExonInf",this.props.handleUpdateInfRend)
    //n
    return (
      <>
  ...
  decideText(transfk, domset, singleexon) {
    ...
    ////console.log("transfkstr", transfkstr);
    //console.log("decidetext");
