        ...
        {this.state.arraylis.length > 0 ? (
          <div className="container-fluid align-items-center">
            <ul className="nav nav-tabs ">
              <li className="nav-item">
                <a href="#" onClick={this.toggle_exonfull}>
                  <span
                    ...
                    style={{fontSize: this.state.exonfull ? 20 : 15, fontWeight: 500, color:"black" }}
              ...
              <li className="nav-item">
                <a onClick={this.toggle_exonNightingale} href="#">
                  <span
                    ...
                    style={{ fontSize: this.state.exonNightingale ? 20 : 15, fontWeight: 500, color:"black" }}
              ...
              <li className="nav-item">
                <a onClick={this.toggle_exonaln} href="#">
                  <span
                    className={this.state.exonaln ? "badge badge-dark" : "badge badge-light"}
                    style={{ fontSize: this.state.exonaln ? 20 : 15, fontWeight: 500, color:"black" }}
            ...
            {this.state.exonfull ? (
              ...
              <>
              <NightingaleExonsVista transwhole={this.state.arraylis[this.state.arraylis.length-1]} />
              </>
            ) :
              this.state.exonaln ? (
              <RenderExonsAln
