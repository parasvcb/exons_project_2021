            ...
            <protvista-manager
              ...
              <protvista-navigation length ={lengthSeq}  /> 
                ...
                <div className = "container">
                  <Collapsible trigger={
                    <button className="btn btn-info"> Show/Hide Details</button>
                  }>
                {/* <button className="btn btn-info" data-toggle="collapse" data-target={"#demo" + this.props.variable} >Details...</button> */}
                  <div className="h-100 border"
                       style={{paddingTop: '5px',  overflowY:"scroll"}}>
