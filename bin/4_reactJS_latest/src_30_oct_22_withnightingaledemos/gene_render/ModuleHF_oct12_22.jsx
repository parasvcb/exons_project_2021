              ...
              trans.secondaryStructure.split('-').map(hesTypes => {
                        ...
                        if (hesTypes.length>2) {
                          ...
                          if (indSS[0]=="E"){
                            ...
                            eleToPush={"start":'',"end":'',"shape":"line","fill":"transparent","color":"#000000"}
                          ...
                          indSS[1].split('_').map(spans => {
                            ...
                            let ssDat={'start':start, 'end': end,'type':'Secondary structure','description':datString, 'tooltip':''}
    ...
    return (
      ...
      <div className="container py-2 px-2">
        <div className="row gx-5 gy-5 ">
          ...
          <div className="border col-sm-6 col-md-8 p-3" style={cardStyle1}>
            <div>
              <a
        ...
        <div className="border col-6 col-md-4 p-3" style={cardStyle2}>
          <div>
            <h4 >Constituents</h4>
              <div >
