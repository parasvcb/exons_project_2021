...
ggsave(gg,filename = 'results/Fig1_panelC.pdf')
...
#p3 <- p3 + coord_cartesian(ylim=c(0, 50))
ggsave(gg1,filename = 'results/Fig1_panelC_withoutExtras.pdf')
...
#p3 <- p3 + coord_cartesian(ylim=c(0, 50))
ggsave(gg2,filename = 'results/Fig1_panelC_withoutExtras_NonZeros.pdf')
