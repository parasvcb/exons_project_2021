...
def giveExonSelectionAdvanced(exonMatrix, utmrdtag, exonsObList, constAltTag, gene):
            ...
            if hasid in refSeq:
                ...
                for seqvar in compareExonList[hasid]:
                    ...
                    for a in align:
                        ...
                        print (seq1Length, seq2Length, identity1, identity2, cov1, cov2)
                        print (seqvar, hasid, gene)
                        print ("\n\n")
                        if identity1 == 1.0 or identity2 == 1.0:
                            ConstWAAchassign += [int(hasid.split(':')[0])]
                        else:
                            ConstWAAchframec += [int(hasid.split(':')[0])]
                        break
    
    ConstWAAchassign = list(set(ConstWAAchassign))
    ConstWAAchframec = list(set(ConstWAAchframec))
    ...
    #     sys.exit()
    return ConstitutiveWaachange, ConstWAAchassign, ConstWAAchframec
