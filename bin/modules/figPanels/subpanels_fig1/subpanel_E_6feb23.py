...
def constitutive_alternate_with_freq(gene):
    ...
    pos_CodingAltWaachange=[i for i in exonMatrix if exonMatrix[i][0]=='T' and exonMatrix[i][1]=='A' and exonMatrix[i][3]>0]
    ...
    return CodingStrict, CodingMajorlyConstitutive, CodingAlternate, CodingAlternateWithSS, CodingConstitutive, CodingConstitutiveWaachange, CodingAltWaachange
...
def exon_length(has,res_dir,genes_cond,output_stats):
    ...
    for gene in has:
        if gene in genes_cond:
            CodingStrict, CodingMajorlyConstitutive, CodingAlternate, CodingAlternateWithSS, CodingConstitutive, CodingConstitutiveWaachange, CodingAltWaachange = constitutive_alternate_with_freq(has[gene])
    ...
    tabularLength += "4_CodingAltWaachange\t%s\n"%cm.stats(A_CodingAltWaachange)
