...
df1 = read.csv(paste0(source_dir,"Fig2_1_N_extchange_histogram.csv"))
...
labs(y="Frequency", x="Length_range", subtitle="Change_in_aa_length_in_Ncases") + theme (axis.text.x = element_text(angle = 45, hjust = 1, size = 10))
...
df5 = read.csv(paste0(source_dir,"Fig2_1_N_extconserved_fraction.csv"))
...
save_plot(paste0(out_dir,"Fig2_1_N.pdf"), plot2by2,
