...
df1 = read.csv(paste0("results/Individual",systemFile,"alljunct_window3.csv"))
df1$Type <- "1_alljunct"
df2 = read.csv(paste0("results/Individual",systemFile,"background_window3.csv"))
df2$Type <- "2_background"
df3 = read.csv(paste0("results/Individual",systemFile,"AltAlt_window3.csv"))
df3$Type <- "3_AltAlt"
df4 = read.csv(paste0("results/Individual",systemFile,"ConsAlt_window3.csv"))
df4$Type <- "4_ConsAlt"
df5 = read.csv(paste0("results/Individual",systemFile,"ConsCons_window3.csv"))
df5$Type <- "5_ConsCons"
df6 = read.csv(paste0("results/Individual",systemFile,"ConsCons_window3.csv"))
df6$Type <- "6_ConsCons"
...
ggsave(p1,filename=paste0("results/fig2_",systemFile,"junctions_PI.pdf"))