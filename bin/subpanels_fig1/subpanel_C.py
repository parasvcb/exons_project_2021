...
def exon_counting(has,res_dir,condition,fout ):
    ...
    for gene in has:
        if  gene in condition:
            ...
            res1,res2=cm.split_cases(tempExAltUTR)
            ...
            res1,res2=cm.split_cases(tempExMajorUTR)
